...
- **[Bài 2](./5_java_m4_bai2_Microservices.md)** — lý thuyết MS; **lab ecommerce** (JWT xuyên service) làm **sau** bài này
...
1. Gắn vào `SecurityContextHolder`:
...
| 4   | `PermissionLoader`        | roleIds → Setpermission code                                           |
...
1. Mở [http://localhost:8080/swagger-ui/index.html](http://localhost:8080/swagger-ui/index.html)
...
- **Tiếp theo — lab MS ecommerce (JWT xuyên service):** [Bài 2](./5_java_m4_bai2_Microservices.md) · `[demo-bai2-ecommerce-ms](../../demo-bai2-ecommerce-ms)`
