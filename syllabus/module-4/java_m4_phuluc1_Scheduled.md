...
- *(Khuyến khích)* **Module 4 — Bài 4**: Authentication / Authorization — gắn ví dụ khóa tài khoản với flow đăng ký + kích hoạt
...
- Module 4 — Bài 4 Auth (`syllabus/pdf/java_m4_bai4_Authentication_Authorization.pdf`)
